...
const ContactForm = () => {
    ...
    return (
        <div id="Contact" className="max-w-lg mx-auto mt-10 mb-4 p-8 bg-gray-800 shadow-lg rounded-lg dark:bg-gray-800">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    ...
                    <input
                        ...
                        required
                        className="w-full mt-1 p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
